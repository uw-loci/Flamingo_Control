    ...
    def to_workflow_dict(self) -> Dict[str, Any]:
        ...
        workflow["Experiment Settings"] = {
            ...
            "Display max projection": str(
                self.experiment_settings.display_max_projection
            ).lower(),
            "Work flow live view enabled": str(
                self.experiment_settings.live_view_enabled
            ).lower(),
        }
    ...
    def create_snapshot(
        ...
        return cls(
            ...
            experiment_settings=ExperimentSettings(
                save_data=False, display_max_projection=True, comment="GUI Snapshot"
            ),
        )
