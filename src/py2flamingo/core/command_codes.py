...
class SystemCommands:
    ...
    # Note: Despite the name "SET", 0x1013 is used to QUERY available storage paths
    # when int32Data0=0. The server's storagePathSet() function handles both query and set.
