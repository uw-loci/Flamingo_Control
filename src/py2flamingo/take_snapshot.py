...
def take_snapshot(connection_data:list, xyzr_init:Tuple[float,float,float,float], visualize_event,  image_queue,
                  command_queue,stage_location_queue, send_event, laser_channel='Laser 3 488 nm', laser_setting='5.00 1'):
