...
class EllipseController:
    ...
    def trace_sample(
        self, start_angle: float = 0.0, end_angle: float = 360.0, step: float = 90.0
        ...
        try:
            ...
            for angle in angles:
                ...
                image = (
                    self.sample_controller.capture_image()
                )  # capture image at this angle
            ...
            if ellipse_params_list:
                combined_params = self.ellipse_service.combine_ellipse_parameters(
                    ellipse_params_list
                )
