...
class TestFlamingoError(unittest.TestCase):
    ...
    def test_error_with_cause(self):
        ...
        error = FlamingoError(message="Wrapped error", cause=original)
    ...
    def test_to_dict(self):
        ...
        error = FlamingoError(
            message="Test error", error_code=1001, context={"test": True}
        )
    ...
    def test_format_user_message(self):
        ...
        error = FlamingoError(
            message="Connection failed", suggestions=["Check network", "Verify IP"]
        )
    ...
    def test_format_log_message(self):
        ...
        error = FlamingoError(
            message="Test error", error_code=1001, context={"location": "test"}
        )
...
class TestErrorSubclasses(unittest.TestCase):
    ...
    def test_command_error(self):
        ...
        error = CommandError(
            "Command failed", command_code=12345, error_code=ErrorCodes.COMMAND_FAILED
        )
    ...
    def test_hardware_error(self):
        ...
        error = HardwareError(
            "Stage limit reached", component="stage", error_code=ErrorCodes.STAGE_LIMIT
        )
...
class TestWrapExternalError(unittest.TestCase):
    ...
    def test_wrap_external_error(self):
        ...
        wrapped = wrap_external_error(
            original, "Value processing failed", ValidationError, field="test_field"
        )
...
class TestErrorFormatter(unittest.TestCase):
    ...
    def test_format_for_user_flamingo_error(self):
        ...
        error = ConnectionError("Connection failed", suggestions=["Check network"])
    ...
    def test_format_for_json(self):
        ...
        error = CommandError("Command failed", command_code=12345)
...
class TestErrorLogger(unittest.TestCase):
    ...
    def test_log_error_flamingo_error(self, mock_get_logger):
        ...
        logger = ErrorLogger()
        error = ConnectionError(
            "Test connection error", error_code=ErrorCodes.CONNECTION_REFUSED
        )
        ...
        self.assertTrue(any(call[0][0] == logging.ERROR for call in calls))
...
class TestRealWorldScenarios(unittest.TestCase):
    ...
    def test_connection_timeout_scenario(self):
        ...
        error = ConnectionError(
            ...
            context={"ip_address": "192.168.1.100", "port": 53717, "timeout": 5.0},
        ...
        self.assertIn(
            str(ErrorCodes.CONNECTION_TIMEOUT), log_msg
        ...
        self.assertEqual(
            gui_data["severity"], "error"
        )  # Timeout errors have 'error' severity
    ...
    def test_command_chain_error_scenario(self):
        ...
        workflow_error = WorkflowError(
            ...
            error_code=ErrorCodes.WORKFLOW_FAILED,
            cause=command_error,
            context={"step": 5, "total_steps": 20, "elapsed_time": 120.5},
            suggestions=[
